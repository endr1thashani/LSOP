...
const ModalAdd = ({closeModal}) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post('http://localhost:5000/probability-staying', {
        staffNr,
        gender,
        year,
        year23,
      ...
      .then((res) => {
        setSuccess('Probability staying created');
        closeModal();
      })
      .catch((err) => {
        setError('Probability staying already exists');
      });
  };
