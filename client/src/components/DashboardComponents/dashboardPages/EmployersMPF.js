...
import ModalAdd from '../../Modals/EmployersMpf/ModalAdd'
...
const EmployersMPF = () => {
  ...
  return (
    <div className='w-full flex'>
      ...
      <h1 className='font-bold text-xl md:text-3xl mt-[10px]'>Employer's MPF Contributions</h1>
